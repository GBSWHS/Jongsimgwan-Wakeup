...
export default function LoginForm () {
  ...
  return (
    <form onSubmit={handleSubmit}>
        <Card>
          <span className="block">정심관 기상송 관리 시스템 로그인</span>
          <small>정심관 출사 관리프로그램이랑 정보가 같습니다.</small>
        ...
        <div className="inline-block px-10 my-5 w-full">
          <button type="submit" className="inline w-full max-w-sm align-top bg-green-500 text-white rounded-md shadow p-2">로그인!</button>
        </div>
      </form>
  )
}
