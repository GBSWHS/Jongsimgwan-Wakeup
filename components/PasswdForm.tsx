...
export default function LoginForm () {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="inline-block px-10 my-1 w-full">
        <button type="submit" className="inline w-full max-w-sm align-top bg-green-500 text-white rounded-md shadow p-2">변경</button>
      </div>
      <div className="inline-block px-10 w-full">
        <Link href="/"><button className="inline w-full max-w-sm align-top bg-gray-500 text-white rounded-md shadow p-2">다음에 변경</button></Link>
      </div>
    </form>
  )
}
